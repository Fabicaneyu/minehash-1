...
public class PrototipoOshi {

    public static void main(String[] args) {

        Logger LOG = LoggerFactory.getLogger(PrototipoOshi.class);
        ...
        LOG.info("Checando informação do sistema...");
        printComputerSystem(hal.getComputerSystem());

        LOG.info("Checando processador...");
        printProcessor(hal.getProcessor());

        LOG.info("Checando memória...");
        printMemory(hal.getMemory());

//        LOG.info("Checando CPU...");
//        printCpu(hal.getProcessor());
        LOG.info("Checando processos");
        printProcesses(os, hal.getMemory());

        LOG.info("Checando sensores...");
        printSensors(hal.getSensors());

        LOG.info("Checando fontes de energia...");
        printPowerSources(hal.getPowerSources());

//        LOG.info("Checando discos...");
//        printDisks(hal.getDiskStores());
        LOG.info("Checando sistema de arquivos...");
        printFileSystem(os.getFileSystem());

//        LOG.info("Checando interface Network...");
//        printNetworkInterfaces(hal.getNetworkIFs());
        LOG.info("Checando parâmetros da Network...");
        printNetworkParameters(os.getNetworkParams());

//        // hardware: displays
//        LOG.info("Checando displays...");
//        printDisplays(hal.getDisplays());
//        // hardware: USB devices
//        LOG.info("Checando dispositivos USB...");
